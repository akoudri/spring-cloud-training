...
import fr.cenotelie.training.movies.configuration.MessagesConfig;
import fr.cenotelie.training.movies.dao.MoviesDAO;
import fr.cenotelie.training.movies.dto.Book;
import fr.cenotelie.training.movies.exceptions.MovieNotFoundException;
import fr.cenotelie.training.movies.model.Movie;
import fr.cenotelie.training.movies.proxies.BookProxy;
